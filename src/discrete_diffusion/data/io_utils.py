...
def load_data_irene(paths, dataset_name, feature_params):
    ...
    for path in paths:
        path = str(path)
        path = path + "/"
        data_adj = np.loadtxt(path + "ENZYMES_A.txt", delimiter=",").astype(int)
        data_node_att = np.loadtxt(path + "ENZYMES_node_attributes.txt", delimiter=",")
        data_node_label = np.loadtxt(path + "ENZYMES_node_labels.txt", delimiter=",").astype(int)
        data_graph_indicator = np.loadtxt(path + "ENZYMES_graph_indicator.txt", delimiter=",").astype(int)
        data_graph_labels = np.loadtxt(path + "ENZYMES_graph_labels.txt", delimiter=",").astype(int)
