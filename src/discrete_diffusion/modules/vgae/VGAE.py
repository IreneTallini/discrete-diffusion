...
class VGAE(nn.Module):
    def __init__(self, feature_dim, hidden_dim, latent_dim):
        ...
        self.base_gcn = GraphConvSparse(feature_dim, hidden_dim)
        self.gcn_mean = GraphConvSparse(hidden_dim, latent_dim, activation=lambda x: x)
        self.gcn_logstddev = GraphConvSparse(hidden_dim, latent_dim, activation=lambda x: x)
    ...
    def encode(self, batch):
        ...
        gaussian_noise = torch.randn(batch.num_nodes, self.latent_dim)
